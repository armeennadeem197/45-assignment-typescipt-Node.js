...
let personName = "Armeen";
console.log(`Hello${personName},would you like to learn some Python today?”`);
//Exersices 3
//Name Cases: Store a person’s name in a variable,
// and then print that person’s name in lowercase, uppercase, and titlecase.
let personNames = "Armeen";
...
let quotes = "Think a hundred times before you take a decision, but once that decision is taken, stand by it as one man. Epect the best, prepare for the worst.";
...
let names = ["Maryam", "Hania", "Areeha", "Laiba", "Neha", "Maham"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
console.log(names[5]);
//Exersices 12
let num = ["Maryam", "Hania", "Areeha", "Laiba", "Neha", "Maham"];
let messages = "you have invite to my party.";
...
let guestlist = ["Mryam", "Neha", "Laiba", "Areeha"];
...
let guestlists = ["Maryam", "Neha", "Areeha", "Hania"];
...
let guestslist = ["Alishba", "Maryam", "Faiz", "Neha", "Areeha", "Hania", "Anum"];
//print message 
...
let placesToVisit = ["pairs", "italy", "london", "china", "australia"];
...
let current_users = ["Maham", "Saba", "Iqra", "Ayesha", "Admin"];
let new_users = ["Armeen", "Faiz", "Alisba", "Admin", "Rahila"];
...
let animals = ["dog", "Wolves", "Elephants,"];
...
function describe_city(nameofCity, country = "country") {
...
//Define a function to print each magician name from an array
function show_magicia(magician) {
    magician.forEach(name => console.log(name));
}
//function to make a magicians  great through map() it will modify array
